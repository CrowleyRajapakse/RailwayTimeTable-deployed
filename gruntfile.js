...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    env: {
	  ...
	  MONGOLAB_URI:  'mongodb://SampathRajapakse:1qaz2wsx@Q@ds159866.mlab.com:59866/railwayplatform'
    },
    watch: {
      serverViews: {
  ...
  grunt.task.registerTask('mongoose', 'Task that connects to the MongoDB instance and loads the application models.', function () {
    ...
    // Connect to database
    mongoose.connect( 'mongodb://SampathRajapakse:1qaz2wsx@Q@ds159866.mlab.com:59866/railwayplatform', function (db) {
      done();
    });
  });
